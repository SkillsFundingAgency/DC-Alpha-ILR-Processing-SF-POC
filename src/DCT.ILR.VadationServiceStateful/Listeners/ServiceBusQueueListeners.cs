...
namespace DCT.ILR.VadationServiceStateful.Listeners
{
    ...
    {        
        ...
        public ServiceBusQueueListeners(Func<ServiceBusQueueListernerModel, Task> callback, string serviceBusConnectionString, string queueName)
        {
            _callback = callback;
